# Graph Report - nickraspy-portfolio  (2026-07-25)

## Corpus Check
- 43 files · ~14,092 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 491 nodes · 699 edges · 37 communities (30 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3abae538`
...
Cohesion: 0.15
Nodes (23): AdminPage(), metadata, POST(), POST(), POST(), GET(), POST(), loadWorkbook() (+15 more)
...
Cohesion: 0.06
Nodes (31): ajv, next, dependencies, ajv, next, postgres, react, react-dom (+23 more)
...
Cohesion: 0.14
Nodes (23): ContactPayload, isSameOrigin(), json(), normalizedName(), POST(), remoteAddress(), text(), TurnstileResult (+15 more)
...
## Knowledge Gaps
- **215 isolated node(s):** `metadata`, `ValidatedImport`, `ContactPayload`, `TurnstileResult`, `geistSans` (+210 more)
...
- **Why does `$defs` connect `Portfolio Schema Core` to `translations`, `Contact Translation Schema`, `sortOrder`, `Project Entry Schema`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `properties` connect `Schema Collection Rules` to `Portfolio Schema Core`, `id`?**
